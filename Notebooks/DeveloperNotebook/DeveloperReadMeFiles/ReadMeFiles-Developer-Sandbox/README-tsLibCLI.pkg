#-----------------------------------------------------------
#"Time-stamp: <05/12/2015  9:22:50 AM rsg>"
#-----------------------------------------------------------
...
8. tsGistGetTerminalSizePkg
   ...
   8.1 tsGistGetTerminalSize.py

       Third-party module for acquiring the character size
       of the Python console window as tuple (width, height)
       on host operating systems (such as Linux, Mac OS X,
...
10. tsOperatorSettingsParserPkg
   ...
   10.1 tsOperatorSettingsParser.py
...
11. tsPlatformRunTimeEnvironmentPkg
    ...
    11.1 tsPlatformRunTimeEnvironment.py
