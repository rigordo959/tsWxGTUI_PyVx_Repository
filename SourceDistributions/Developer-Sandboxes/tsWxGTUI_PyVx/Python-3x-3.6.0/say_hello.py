#! /usr/bin/env python
# "Time-stamp: <02/15/2015  7:41:52 AM rsg>"
'''
...
#    of the TeamSTARS "tsWxGTUI" Toolkit. It identifies:
#
#    1. TeamSTARS "tsWxGTUI" Toolkit trademark
#    2. supported TeamSTARS "tsWxGTUI" Toolkit software
#       distribution
...
#    7. TeamSTARS "tsWxGTUI" Toolkit warranty disclaimer
#
# Usage (examples):
#
#    python say_hello.py
