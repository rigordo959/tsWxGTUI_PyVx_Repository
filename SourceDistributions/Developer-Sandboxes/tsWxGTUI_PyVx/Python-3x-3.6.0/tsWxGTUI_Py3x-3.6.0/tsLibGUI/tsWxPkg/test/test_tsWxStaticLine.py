#! /usr/bin/env python
#"Time-stamp: <09/20/2013  4:40:44 AM rsg>"
'''
test_tsWxStaticLine.py - Test application program. It demonstrates
features and operation of the tsWxStaticLine class and associated
building block components of tsLibCLI and tsLibGUI.
'''
#################################################################
#
# File: test_tsWxStaticLine.py
#
# Purpose:
#
#    Test application program. It demonstrates features and
#    operation of the tsWxStaticLine class and associated
#    building block components of tsLibCLI and tsLibGUI.
#
# Limitations:
#
...
# Modifications:
#
#    2012/07/04 rsg Derived design from test_tsWxGauge.
#
# ToDo:
#
#   None
...
class _Prototype(wx.Frame):
    ...
    def TestStaticLine(self, theFrame):
        '''
        '''
        ...
        self.panel1 = wx.Panel(self.theFrame,
                               wx.ID_ANY,
                               label='Vertical StaticLine Example',
        ...
        self.panel2 = wx.Panel(self.theFrame,
                               wx.ID_ANY,
                               label='Horizontal StaticLine Example',
                               style=boxHorizontalPanelStyle)
        ...
        try:
            ...
            msg ='TestStaticLine:  wx.StaticLine errorCode=%s' % str(errorCode)
            print('DEBUG: %s\n' % msg)
...
##        self.Close()
    ...
    def EvtStaticLine(self, event):
        '''
        '''
        self.log.write('EvtStaticLine: %d\n' % event.IsChecked())
