#! /usr/bin/env python
#"Time-stamp: <06/04/2013  5:51:01 AM rsg>"
'''
test_tsWxVt100Widgets.py -Test application program. It demonstrates
features and operation of the tsWxGTUI toolkit and associated
building block components of tsLibCLI and tsLibGUI.
'''
#################################################################
#
# File: test_tsWxVt100Widgets.py
#
# Purpose:
#
...
__title__     = 'test_tsWxVt100Widgets'
__version__   = '2.3.0'
__date__      = '06/03/2013'
...
##                         startupinfo=None,
##                         creationflags=0)
## tsSysCommands.TsSysCommands.tsCall('TERM=vt100')
...
##                self.Show()
        ...
        DISPLAY_NON_COLOR_ATTRIBUTE_MASK = DISPLAY_BLINK | \
                                           DISPLAY_BOLD | \
                                           DISPLAY_DIM | \
                                           DISPLAY_NORMAL | \
                                           DISPLAY_REVERSE | \
        ...
        print('DISPLAY_BLINK     = 0x%8.8X' % curses.A_BLINK)
        print('DISPLAY_BOLD      = 0x%8.8X' % curses.A_BOLD)
        print('DISPLAY_DIM       = 0x%8.8X' % curses.A_DIM)
        print('DISPLAY_NORMAL    = 0x%8.8X' % curses.A_NORMAL)
        print('DISPLAY_REVERSE   = 0x%8.8X' % curses.A_REVERSE)
        print('DISPLAY_STANDOUT  = 0x%8.8X' % curses.A_STANDOUT)
        print('DISPLAY_UNDERLINE = 0x%8.8X' % curses.A_UNDERLINE)

        print('DISPLAY_NON_COLOR_ATTRIBUTE_MASK=0x%X' % \
              DISPLAY_NON_COLOR_ATTRIBUTE_MASK)
