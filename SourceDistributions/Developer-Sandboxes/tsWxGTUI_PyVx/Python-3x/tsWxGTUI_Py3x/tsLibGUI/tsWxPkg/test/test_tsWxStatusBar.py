#! /usr/bin/env python
#"Time-stamp: <09/20/2013  4:40:57 AM rsg>"
'''
test_tsWxStatusBar.py - Application program to mimic some
features of the Graphical TextUser Interface.
'''
#################################################################
#
# File: test_tsWxStatusBar.py.py
#
# Purpose:
#
