#! /usr/bin/env python
#"Time-stamp: <04/27/2014  2:06:21 PM rsg>"
'''
test_tsWxGauge.py - Test application program. It demonstrates
features and operation of the tsWxGauge class and associated
...
#    operation of the tsWxGauge class and associated
#    building block components of tsLibCLI and tsLibGUI.
#
# Limitations:
#
...
# Modifications:
#
#    2014/04/27 rsg Modified TestGauge to simulate incrementing
...
class _Prototype(wx.Frame):
    ...
    def TestGauge(self, theFrame):
        ...
        self.panel2 = wx.Panel(self.theFrame,
                               wx.ID_ANY,
                               label='Horizontal Gauge Example',
                               style=boxHorizontalPanelStyle)
...
##                          size=(250, 25),
            ...
            msg ='TestGauge:  wx.Gauge errorCode=%s' % str(errorCode)
            print('DEBUG: %s\n' % msg)
...
##        self.Close()
    ...
    def EvtGauge(self, event):
        '''
        '''
        self.log.write('EvtGauge: %d\n' % event.IsChecked())
