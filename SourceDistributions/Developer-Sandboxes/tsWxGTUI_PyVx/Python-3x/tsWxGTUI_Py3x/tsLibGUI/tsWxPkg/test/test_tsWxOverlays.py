#! /usr/bin/env python
#"Time-stamp: <09/20/2013  4:39:44 AM rsg>"
'''
test_tsWxOverlays.py - Application program to mimic some features of
the Graphical Text User Interface.
'''
#################################################################
#
# File: test_tsWxOverlays.py
#
# Purpose:
#
...
dialogEnabled = True
radioBoxEnabled = False # dialogEnabled
radioButtonEnabled = False # dialogEnabled
