#! /usr/bin/env python
#"Time-stamp: <12/14/2014  2:52:10 PM rsg>"
'''
...
__copyright__ = 'Copyright (c) 2011-2014 Software Gadgetry. ' + \
                'All rights reserved.'
