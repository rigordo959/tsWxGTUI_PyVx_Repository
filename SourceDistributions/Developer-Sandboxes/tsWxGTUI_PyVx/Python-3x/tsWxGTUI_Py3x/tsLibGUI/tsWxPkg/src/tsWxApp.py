#! /usr/bin/env python
# "Time-stamp: <10/25/2013 11:04:28 AM rsg>"
'''
...
from tsWxPyOnDemandOutputWindow import PyOnDemandOutputWindow as wxPyOnDemandOutputWindow
...
##            self.RedirectStdio(self.ts_filename)
        ...
        except AttributeError as RedirectError:
...
##            self.Destroy()
    ...
    def tsBootstrapApp(self):
        ...
        except AttributeError as OnPreInitError:
        ...
        except AttributeError as OnInitError:
