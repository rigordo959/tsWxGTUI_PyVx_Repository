#! /usr/bin/env python
# "Time-stamp: <10/25/2013  6:33:35 AM rsg>"
'''
...
try:
    ...
    from tsWxEvent import wxEVT_COMMAND_LEFT_CLICK
    from tsWxEvent import wxEVT_HELP
    from tsWxEvent import wxEVT_INIT_DIALOG
    from tsWxEvent import wxEVT_MIDDLE_DOWN
    from tsWxEvent import wxEVT_SIZE
    from tsWxEvent import wxEVT_SYS_COLOUR_CHANGED
...
##            id = source.NewId()
        ...
        except Exception as sourceError:
    ...
    def DeletePendingEvents(self):
        ...
        except Exception as deletePendingEventsError:
    ...
    def GetClientData(self):
        ...
        except Exception as getClientDataError:
    ...
    def IsUnlinked(self):
        ...
        except Exception as isUnlinkedError:
    ...
    def ProcessEventLocally(self, event):
        ...
        except Exception as ProcessEventLocallyError:
    ...
    def SafelyProcessEvent(self, event):
        ...
        try:
            ...
            try:
                ...
                except Exception as loopErrorCode:
...
##                status = False
    ...
    def Unlink(self):
        ...
        except Exception as unlinkError:
