#! /usr/bin/env python
# "Time-stamp: <10/22/2013  5:29:34 PM rsg>"
'''
...
# Usage (example):
#
#    import tsOperatorSettingsParserPkg
#
# Requirements:
#
#    Python 2.5 or later.
...
# Modifications:
#
#    2013/05/05 rsg Added tsCommandLineParserPkg package to
#                   "tsLibCLI".
#
# ToDo:
#
...
theName = 'tsOperatorSettingsParserPkg'
