#! /usr/bin/env python
# "Time-stamp: <11/16/2014  5:55:02 AM rsg>"
'''
...
#       a. Splash Screen
#
#          Docstrings to be used for Trademark, Copyright, License
...
#                   trademark, copyright, license and notices.
#
...
#
#    2014/03/15 rsg Updated trademark, copyright, license and notice.
#
...
ProductName   = '"%s" Toolkit' % tsWxGTUI_PyVx
...
# See file "SplashScreenDesignersGuide.txt" located in directory
...
tion and redistribution of the "tsWxGTUI" Toolkit may
be found in the file "NOTICES.txt" located in directory
"./%s/tsDocCLI/Usage_Terms_and_Conditions".
''' % tsWxGTUI_PyVx

#########################################################################

# See file "SplashScreenDesignersGuide.txt" located in directory
# "./tsWxGTUI_PyVx/tsDocCLI/Usage_Terms_and_Conditions".
#
...
theCopyright = '''
%s, v0.0.0 (pre-alpha build 11/16/2014)
  ...
  Each third-party component is subject to its author`s
...
are distributed as free and open source software. You
may use, modify and redistribute it only under the
terms and conditions set forth in the "COPYRIGHT.txt"
and "LICENSE.txt" files located in directory "./%s
/tsDocCLI/Usage_Terms_and_Conditions".
