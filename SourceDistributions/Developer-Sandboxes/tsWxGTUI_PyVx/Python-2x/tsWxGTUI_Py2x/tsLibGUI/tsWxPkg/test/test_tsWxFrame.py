#! /usr/bin/env python
#"Time-stamp: <06/04/2013  2:51:05 AM rsg>"
'''
test_tsWxFrame.py - Test application program. It demonstrates
...
#    operation of the tsWxFrame class and associated
#    building block components of tsLibCLI and tsLibGUI.
#
#    1. Frame
