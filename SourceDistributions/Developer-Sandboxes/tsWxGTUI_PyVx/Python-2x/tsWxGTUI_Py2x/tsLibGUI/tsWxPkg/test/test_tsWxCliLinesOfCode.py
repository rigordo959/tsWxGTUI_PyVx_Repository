#! /usr/bin/env python
#"Time-stamp: <09/20/2013  4:06:18 AM rsg>"
'''
test_tsWxCliLinesOfCode.py - Application program to scan a file
...
#################################################################
#
# File: test_tsWxCliLinesOfCode.py
#
# Purpose:
#
...
__title__     = 'test_tsWxCliLinesOfCode'
__version__   = '1.3.0'
__date__      = '12/25/2011'
...
from tsWxCommandLineEnv import CommandLineEnv as wxCommandLineEnv
...
Examples (default case):
    ...
    python %prog
    python %prog -i=./ -o=./tsWxCliLinesOfCodeStatistics.txt
    python %prog -i ./ -o ./tsWxCliLinesOfCodeStatistics.txt
    '''))
    ...
    parser.add_argument(
        '-o', '--outputFilePath',
            ...
            default='./tsWxCliLinesOfCodeStatistics.txt',
            type=str,
...
##            self.textCtrl.Show()
    ...
    def reportResults(self,
        ...
        self.writeResults('  Input Path:     <%s>.' % self.myInputPath)
...
class _Prototype(object):
    ...
    def __init__(self):
        ...
        LinesOfCode = TsCliLinesOfCode(theLogger)
