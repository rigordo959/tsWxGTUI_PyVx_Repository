#! /usr/bin/env python
#"Time-stamp: <05/31/2014  7:14:21 AM rsg>"
'''
test_tsWxScrolledWindowDual.py - Test application program.
It demonstrates features and operation of the tsWxScrolled,
...
#################################################################
#
# File: test_tsWxScrolledWindowDual.py
#
# Purpose:
#
...
__title__     = 'test_tsWxScrolledWindowDual'
__version__   = '2.0.0'
__date__      = '06/04/2013'
