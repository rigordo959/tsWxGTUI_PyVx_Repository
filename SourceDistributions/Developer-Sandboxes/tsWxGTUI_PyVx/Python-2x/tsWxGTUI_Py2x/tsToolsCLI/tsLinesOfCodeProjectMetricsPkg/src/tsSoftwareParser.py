#! /usr/bin/env python
#"Time-stamp: <11/15/2013  8:32:14 AM rsg>"
'''
tsSoftwareParser.py - Class to scan a file directory and produce
...
# Purpose:
#
#    Class to scan a file directory and produce a report of the
...
class TsSoftwareParser(object):
    '''
    Class to scan a file directory and produce a report of the number
    of source code files, lines of code, blank/comment lines, word
