#! /usr/bin/env python
#"Time-stamp: <10/28/2014  5:10:33 AM rsg>"
'''
tsLOCPMOperatorSettingsParser.py - Class to parse the command
line entered by the operator of an application program. Parsing
...
elif platform.python_version() >= "3.0.0" :

    from optparse import OptionParser
    import getopt

elif platform.python_version() >= "2.7.0":
...
Optional Aguments:
  ...
  -m {argparse}, --module {argparse}
                        ...
                        (To demonstrate the similarity and differences
                         ...
                         Python recommendation, "argparse", while a
                         Positional Argument is used to override it with
                         a now Python deprecated "optparse" or "getopt")
