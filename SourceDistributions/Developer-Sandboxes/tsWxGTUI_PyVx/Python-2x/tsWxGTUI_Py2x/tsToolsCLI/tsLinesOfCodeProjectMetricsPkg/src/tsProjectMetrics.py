#! /usr/bin/env python
#"Time-stamp: <09/14/2013  5:35:14 PM rsg>"
'''
tsProjectMetrics.py - Class to derive software development
project labor, cost, schedule and productivity metrics from
the software lines of code metrics.
'''
#################################################################
#
