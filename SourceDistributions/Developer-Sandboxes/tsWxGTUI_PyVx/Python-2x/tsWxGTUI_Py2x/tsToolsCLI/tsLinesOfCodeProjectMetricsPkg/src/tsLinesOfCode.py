#! /usr/bin/env python
#"Time-stamp: <09/14/2013  7:12:35 PM rsg>"
'''
tsLinesOfCode.py - Class to coordinate the processes of gathering
software lines of code metrics and deriving, analyzing, estimating
and reporting software development project labor, cost, schedule
...
# Purpose:
#
#    Class to coordinate the processes of gathering software
#    lines of code metrics and deriving, analyzing, estimating
#    and reporting software development project labor, cost,
