...
try:
    ...
    # Use the "tsWxGTUI" Toolkit if available
    import tsLibGUI
    import tsWx as wx
...
if __name__ == '__main__':
    ...
    print("tsWxGTUI_Widget via tsWxGTUI")
...
##      "Hello World via tsWxGTUI")
    ...
    guiTopLevelObjectTitle = 'Application_Frame' # __title__
