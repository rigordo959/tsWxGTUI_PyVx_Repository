#! /usr/bin/env python
#"Time-stamp: <05/31/2014  6:41:50 AM rsg>"
__doc__ = '''
test_tsSysCommands.py - Test application for tsSysCommand.
'''
#################################################################
#
...
# Purpose:
#
#     Test application for tsSysCommand
#
# Limitations:
#
# Usage: test_tsSysCommand.py [options]
#
#     Options:
