#! /usr/bin/env python
#"Time-stamp: <04/08/2015  8:24:45 AM rsg>"
'''
...
from tsWxGTUI_Py3x.tsLibCLI import tsApplication
...
wxFrameNameStr = wx.FrameNameStr
wxDefaultPosition = wx.DefaultPosition
wxDefaultSize = wx.DefaultSize
wxDEFAULT_FRAME_STYLE = wx.DEFAULT_FRAME_STYLE

from tsWxGTUI_Py3x.tsLibGUI.tsWxApp import App as wxApp
...
class cliAPP(tsApplication.TsApplication):
    '''
