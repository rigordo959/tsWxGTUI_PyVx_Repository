#! /usr/bin/env python
# "Time-stamp: <04/08/2015  8:41:48 AM rsg>"
'''
...
if USE_DOUBLE_LINKED_LIST:
    ...
    from tsWxGTUI_Py3x.tsLibGUI.tsWxDoubleLinkedList \
	 import DoubleLinkedList as wxLinkedUserDataList

else:

    from tsWxGTUI_Py3x.tsLibGUI.tsWxNonLinkedList \
	 import NonLinkedList as wxLinkedUserDataList
