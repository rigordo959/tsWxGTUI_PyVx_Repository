...
from tsWxGTUI_Py3x.tsLibGUI import tsWxEvent

from tsWxGTUI_Py3x.tsLibGUI.tsWxDisplay import Display as wxDisplay
from tsWxGTUI_Py3x.tsLibGUI.tsWxFrame import Frame as wxFrame
...
from tsWxGTUI_Py3x.tsLibGUI.tsWxTextCtrl import TextCtrl as wxTextCtrl
...
##        self.ts_Frame.Bind(tsWxEvent.EVT_CLOSE, self.OnCloseWindow)
    ...
    def write(self, text):
        ...
        if self.ts_Frame.display.HasColors:
            ...
            for theKey in list(wx.ThemeToUse['Stdio']['Markup'].keys()):
...
##                    theMarkup = None
    ...
    def tsCreateScrollableRedirectionLog(self):
        ...
        theLogFile = open(thePathName, 'w', 1)
