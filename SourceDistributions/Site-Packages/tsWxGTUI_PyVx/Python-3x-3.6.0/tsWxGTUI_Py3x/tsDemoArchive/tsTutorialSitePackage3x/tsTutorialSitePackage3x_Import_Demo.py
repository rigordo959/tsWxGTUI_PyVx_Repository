#! /usr/bin/env python
# "Time-stamp: <06/09/2015  6:50:23 AM rsg>"
'''
...
##    print('\n\ntsDoubleLinkedList: %s' % dir(tsDoubleLinkedList))
    ...
    from tsWxGTUI_Py3x.tsLibCLI.tsDoubleLinkedList import DoubleLinkedList
...
##         import DoubleLinkedList
    ...
    if CLImode:
        ...
        from tsWxGTUI_Py3x.tsLibCLI.tsCommandLineEnv import CommandLineEnv
...
if CLImode:
    ...
    try:
        ...
        # from tsWxGTUI_Py3x import tsLibGUI
