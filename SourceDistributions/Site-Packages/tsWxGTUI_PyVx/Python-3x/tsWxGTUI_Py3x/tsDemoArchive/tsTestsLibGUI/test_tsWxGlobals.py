#! /usr/bin/env python
# "Time-stamp: <04/04/2015  7:46:51 AM rsg>"
__doc__ = '''
test_tsWxGlobals.py - Test application for tsWxGlobals module.
'''
#################################################################
#
# File: tsWxGlobals.py
...
# Purpose:
#
#     Test application for tsWxGlobals module.
#
# Usage (example):
#
#    # Execute
...
# Limitations:
#
#    1. The "tsToolkitCLI" and the "tsWxGlobals" module are designed
...
#
#    2. This "tsWxGlobals" module establishes a common area for defin-
...
#
#    2015/04/04 rsg Replaced "import tsWxGlobals" by
#                   "import tsWx as wx" and made the associated
#                   "ThemeToUse = wx.ThemeToUse" reference.
#
# ToDo:
#
#    TBD.
...
__title__     = 'test_tsWxGlobals'
__version__   = '1.0.0'
__date__      = '004/04/2015'
__authors__   = 'Richard S. Gordon'
__copyright__ = 'Copyright (c) 2014-2015 ' + \
