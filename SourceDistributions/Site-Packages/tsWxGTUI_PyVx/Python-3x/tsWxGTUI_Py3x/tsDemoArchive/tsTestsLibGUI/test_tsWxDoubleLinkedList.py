#! /usr/bin/env python
#"Time-stamp: <04/04/2015  7:53:20 AM rsg>"
__doc__ = '''
...
#################################################################
#
# File: test_tsWxDoubleLinkedList.py
#
# Purpose:
#
...
# Modifications:
#
#    2015/04/04 rsg Replaced "import tsWxDoubleLinkedList" by
#                   "import tsWx as wx" and made the associated
#                   "DoubleLinkedList = wx.DoubleLinkedList" reference.
#
# ToDo:
#
#   None
...
__title__     = 'test_tsWxDoubleLinkedList'
__version__   = '1.21.0'
__date__      = '04/04/2015'
...
DoubleLinkedList = wx.DoubleLinkedList
