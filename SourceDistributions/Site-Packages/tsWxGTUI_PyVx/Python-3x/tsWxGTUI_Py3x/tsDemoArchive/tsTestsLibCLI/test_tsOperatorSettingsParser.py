#! /usr/bin/env python
#"Time-stamp: <03/28/2015  2:05:29 AM rsg>"
__doc__ = '''
test_tsOperatorSettingsParser.py - Test application for the
...
#################################################################
#
# File: test_tsOperatorSettingsParser.py
#
# Purpose:
#
...
# Modifications:
#
#    2013/05/26 rsg Modified to support various Command Line
#                   Parsers as appropriate to the Python
#                   version unless specified by the operator
#                   via a case-insensitive positional argument
#                   (e.g. "argparse", "OptParse" or "GETOPT")
#
#    2013/06/16 rsg Feedback changes from tsLinesOfCodeMetrics
#                   associated with reporting build information
#                   of top-level application instead of lower-
#                   level tsOperatorSettingsParser module.
#
#    2013/06/16 rsg Revised __doc__ string to clarify use of
#                   Python version appropriate default parser
#                   that can be overriden by operator selection.
#
# ToDo:
#
#################################################################

__title__     = 'test_tsOperatorSettingsParser'
__version__   = '2.3.0'
__date__      = '06/17/2013'
