#! /usr/bin/env python
#"Time-stamp: <03/28/2015  2:01:41 AM rsg>"
'''
...
from tsWxGTUI_Py3x.tsLibCLI import tsDoubleLinkedList
...
def test_low_level_interface(myLogger):
    ...
    myList = tsDoubleLinkedList.DoubleLinkedList("a")
    myList.Add("b")
    myList.Add("c")
    myList.Add("d")
    myList.Add("e")
...
def test_high_level_interface(myLogger):
    ...
    myList = tsDoubleLinkedList.DoubleLinkedList()
    ...
    myList = tsDoubleLinkedList.DoubleLinkedList(lifoMode=False)
    myList.Push("a")
    myList.Push("b")
    myList.Push("c")
    myList.Push("d")
    ...
    myList = tsDoubleLinkedList.DoubleLinkedList(lifoMode=True)
    myList.Push("a")
    myList.Push("b")
    myList.Push("c")
    myList.Push("d")
