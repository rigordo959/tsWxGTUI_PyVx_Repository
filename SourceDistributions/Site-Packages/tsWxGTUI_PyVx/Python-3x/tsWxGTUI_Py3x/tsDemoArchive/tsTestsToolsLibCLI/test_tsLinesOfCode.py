#! /usr/bin/env python
#"Time-stamp: <04/06/2015  7:47:04 AM rsg>"
'''
test_tsLinesOfCode.py - Test and demonstrate the application
program which scans a file directory tree and produces
reports of software source code and development project
metrics.
'''
#################################################################
#
# File: test_tsLinesOfCode.py
#
# Purpose:
#
#    Test and demonstrate the application program which scans
#    a file directory tree and produces reports of software
#    source code and development project metrics.
#
# Limitations:
#
...
from tsWxGTUI_Py3x.tsCommandLineEnv import CommandLineEnv

#--------------------------------------------------------------------------

from tsWxGTUI_Py3x.tsToolsLibCLI import tsLinesOfCode

from tsLinesOfCode import TsLinesOfCode

#--------------------------------------------------------------------------

class test_tsLinesOfCode(TsLinesOfCode):
    '''
    ...
    def __init(self):
        '''
        '''
        TsLinesOfCode.__init__(self)
##      TsOperatorSettingsParser.__init__(self)
