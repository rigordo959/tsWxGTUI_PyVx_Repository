#! /usr/bin/env python
# "Time-stamp: <04/08/2015  7:51:00 AM rsg>"
'''
...
#################################################################
#
# File: tsWxEventLoopActivator.py
#
# Purpose:
#
...
class EventLoopActivator(object):
    ...
    def __init__(self, evtLoop):
        ...
        '''
        theClass = 'EventLoopActivator'

        wx.RegisterFirstCallerClassName(self, theClass)

##        self.tsBeginClassRegistration(theClass, id)
        msg = 'NotImplementedError: %s' % '__init__ in tsWxEventLoopActivator'
