#! /usr/bin/env python
#"Time-stamp: <03/28/2015  2:15:11 AM rsg>"
'''
...
tsru = tsReportUtilities.TsReportUtilities
...
##    sys.exit(0)
    ...
    def open(self, name, mode):
        ...
        except OSError as errorTuple:
            (errno, strerror) = errorTuple
            # Substitute stdout.
