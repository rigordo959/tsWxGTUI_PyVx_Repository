#! /usr/bin/env python
#"Time-stamp: <04/04/2015  8:12:10 AM rsg>"
'''
test_tsWxColorPalette.py - Demonstration and design verifi-
cation test of the foreground/background color pairs provided
by the "tsWxGTUI" Toolkit and its character-mode emulation
of the pixel-mode "wxPython" Graphical User Interface.
'''
#################################################################
#
# File: test_tsWxColorPalette.py
#
# Purpose:
#
...
#                   of wxThemeToUse.
#
#    2015/01/05 rsg Added method tsGetNetworkIdentification and
...
#
#    2015/01/07 rsg Modified __init__ to capture task name at launch.
#
#    2015/01/07 rsg Changed name to "test_tsWxColorPalette"
#                   from "test_tsWxGraphicalTextUserInterface"
#                   in order to fit name @ host on tile line.
#
#    2015/04/04 rsg Replaced "import tsWxGraphicalTextUserInterface" by
#                   "import tsWx as wx" and made the associated
#                   "gtui = wx.GraphicalTextUserInterface" reference.
#
# ToDo:
#
#    None.
...
__title__     = 'test_tsWxColorPalette'
__version__   = '2.16.0'
__date__      = '04/04/2015'
...
wxThemeToUse = wx.ThemeToUse
USE_256_COLOR_PAIR_LIMIT = wx.USE_256_COLOR_PAIR_LIMIT

gtui = wx.GraphicalTextUserInterface
...
class sample(object):
    ...
    def __init__(self):
        ...
        self.ts_Task = sys.argv[0] # capture task name at launch.
        self.ts_Title = ' %s @ %s ' % (
            self.ts_Task.replace('.py', ''),
            self.ts_Host) # [0:min(15, len(self.ts_Host))])
    ...
    def tsGetNetworkIdentification(self):
        ...
        try:
            ...
            socketAliaslist = []
            socketIpaddrlist = []
            fmt1 = 'tsGetNetworkIdentification: '
...
##            self.myLogger.close()
    ...
    def monochromeTest(self):
        ...
        sampleWindow.attron(TaskAttribute)
        sampleWindow.addstr(begin_y + TaskOffset,
                            begin_x + 1,
                            self.ts_Title)
        sampleWindow.attroff(TaskAttribute)
