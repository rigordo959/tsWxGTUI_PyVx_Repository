#!/usr/bin/env python
# "Time-stamp: <04/12/2014  2:53:54 PM rsg>"
#################################################################
#
# File: Tutorial_GUI_4_Curses_LowLevel_WidgetApi_application.py
#
# Purpose:
#
#     Demonstrates Python "Curses" module in source code for
#     Python 2.7.0-2.7.6 and Python 3.0.0-3.4.0.
#
#        From http://docs.python.org/2/library/curses.html:
#            15.11. curses --- Terminal handling for
#                              character-cell displays
#
#     Boiler plate, comments and bug fixes added by Richard S. Gordon.
#
# Capabilities:
#
...
#    # Execute
#
#    python Tutorial_GUI_4_Curses_LowLevel_WidgetApi_application.py
#
#    Repeatedly press "return" / "enter" key to see next display.
#
#################################################################

__title__     = 'Tutorial_GUI_4_Curses_LowLevel_WidgetApi_application'
__version__   = '1.0.0'
__date__      = '04/12/2014'
