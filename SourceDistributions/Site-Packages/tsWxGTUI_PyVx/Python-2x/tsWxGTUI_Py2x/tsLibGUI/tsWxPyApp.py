#! /usr/bin/env python
# "Time-stamp: <04/08/2015  7:09:58 AM rsg>"
'''
...
from tsWxGTUI_Py2x.tsLibGUI.tsWxEvent import Event
from tsWxGTUI_Py2x.tsLibGUI.tsWxEventLoop import EventLoop
from tsWxGTUI_Py2x.tsLibGUI.tsWxEvtHandler import EvtHandler
from tsWxGTUI_Py2x.tsLibGUI.tsWxTaskBar import TaskBar as wxTaskBar
from tsWxGTUI_Py2x.tsLibGUI.tsWxRect import Rect as wxRect
from tsWxGTUI_Py2x.tsLibGUI.tsWxScreen import Screen as wxScreen
...
##        pass
    ...
    def ProcessIdle(self):
        ...
        except Exception, userInputError:
