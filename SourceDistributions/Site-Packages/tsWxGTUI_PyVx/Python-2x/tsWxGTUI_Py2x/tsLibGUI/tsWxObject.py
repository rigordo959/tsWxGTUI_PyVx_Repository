#! /usr/bin/env python
# "Time-stamp: <04/08/2015  5:56:48 AM rsg>"
'''
...
from tsWxGTUI_Py2x.tsLibGUI.tsWxGraphicalTextUserInterface import \
     GraphicalTextUserInterface as tsGTUI
...
##                    'Duplicate Id (%d) replaces predecessor.' % self.ts_Id)
    ...
    def tsUpdateEventAndAcceleratorTables(self,
        ...
        if useSystemEventTable:
            ...
            if not (theEventBindingName in theSystemEventTable.keys()):
...
##                    'name'] = theEventBindingName
            ...
            if not (theEventBindingName in theUserEventTable.keys()):
