#! /usr/bin/env python
# "Time-stamp: <04/19/2015 11:22:32 AM rsg>"
'''
...
#                   of both files.
#
#    2015/04/19 rsg Conditionalized use of curses.pflush() and
#                   curses.doupdate() only when
#                   wx.USE_CURSES_PANEL_STACK is True.
#
# ToDo:
#
#    None
