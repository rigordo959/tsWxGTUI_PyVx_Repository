...
class TextEditBox(wxTextCtrl):
    ...
    def __init__(self,
        ...
        self.KeystrokeActionKeys = self.KeystrokeAction.keys()
    ...
    def tsDumpTextEditBoxCheckPoint(self,
        ...
        if int(character) in KEY_NAMES.keys():
    ...
    def tsDumpTextEditBoxDataBase(self,
        ...
        if USE_CURSOR_DICT_KEY:
            ...
            cursor2OffsetMap = ''
            cursorDictKeys = self.ts_TextBufferCursor2OffsetMap.keys()
        ...
        if USE_CURSOR_DICT_KEY:
            ...
            offset2CursorMap = ''
            offsetDictKeys = self.ts_TextBufferOffset2CursorMap.keys()
