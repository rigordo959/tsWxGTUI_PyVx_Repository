#! /usr/bin/env python
# "Time-stamp: <04/08/2015  9:30:04 AM rsg>"
'''
...
#################################################################
#
# File: tsWxToggleButton.py
#
# Purpose:
#
#    Class to establish a button that stays pressed when clicked
#    by the user. In other words, it is similar to wxCheckBox in
...
#    # Import
#
#    from tsWxToggleButton import ToggleButton as wxToggleButton
#
# Requirements:
#
