#! /usr/bin/env python
# "Time-stamp: <04/19/2015 11:25:59 AM rsg>"
'''
tsWxFrameButton.py - Class to establish a button that
controls the closing, iconizing, maximizing and restoring the
previous size of a Frame type window.
'''
#################################################################
#
# File: tsWxFrameButton.py
#
# Purpose:
#
#     Class to establish a button that controls the closing,
#     iconizing, maximizing and restoring the previous size
#     of a Frame type window.
#
# Usage (example):
#
#    # Import
#
#    from tsWxFrameButton import TopLevelWindowButton
#
# Requirements:
#
...
from tsWxGTUI_Py2x.tsLibGUI.tsWxEvent import EVT_COMMAND_LEFT_CLICK
...
HelpButtonLabel        = wx.ThemeToUse['Frame']['HelpButtonLabel']
...
class FrameButton(Button):
    ...
    iconizing, maximizing and restoring the previous size of a Frame
    type window.
    '''
    def __init__(self,
                 parent,
...
##          self.ts_BackgroundColour = wx.COLOR_BLUE
    ...
    def tsOnHelp(self, evt):
        ...
        theEarliestAncestor = self.tsFindWindowByAssignedId(
            self.ts_EarliestAncestor)
        theEarliestAncestor.HelpAsked = True
    ...
    def tsOnMaximize(self, evt):
        ...
        theEarliestAncestor = self.tsFindWindowByAssignedId(
            self.ts_EarliestAncestor)
        theEarliestAncestor.Maximized = True
    ...
    def tsOnRestoreDown(self, evt):
        ...
        theEarliestAncestor = self.tsFindWindowByAssignedId(
            self.ts_EarliestAncestor)
        theEarliestAncestor.RestoredDown = True
