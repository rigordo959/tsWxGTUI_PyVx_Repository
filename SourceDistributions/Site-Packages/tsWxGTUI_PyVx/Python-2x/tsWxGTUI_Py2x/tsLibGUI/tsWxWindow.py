#! /usr/bin/env python
# "Time-stamp: <04/09/2015  5:31:12 AM rsg>"
'''
...
##                self.tsRoundVertical(yValue))
    ...
    def tsTaskBarDumpPanelStack(self):
        ...
        while not done:
            ...
            except Exception, dumpErrorCode:
                msg = 'tsWxWindow.tsTaskBarDumpPanelStack: ' + \
...
if __name__ == '__main__':
    ...
    try:
        ...
        theApplication = tsApplication.TsApplication(
    ...
    except Exception, theApplication:
