#! /usr/bin/env python
# "Time-stamp: <06/30/2015  6:36:22 AM rsg>"
'''
...
from tsWxGTUI_Py2x.tsLibCLI import tsSysCommands

#--------------------------------------------------------------------------

from tsWxGTUI_Py2x.tsLibGUI.tsWxDoubleLinkedList import \
     DoubleLinkedList as wxDoubleLinkedList
from tsWxGTUI_Py2x.tsLibGUI.tsWxGlobals import ThemeToUse as wxThemeToUse
from tsWxGTUI_Py2x.tsLibGUI.tsWxGlobals import USE_256_COLOR_PAIR_LIMIT
...
from tsWxGTUI_Py2x.tsLibGUI.tsWxCursesKeyCodesDataBase import *
from tsWxGTUI_Py2x.tsLibGUI.tsWxCursesMouseButtonCodesDataBase import *
from tsWxGTUI_Py2x.tsLibGUI.tsWxCursesServices import CursesServices
...
from tsWxGTUI_Py2x.tsLibGUI.tsWxPythonPrivateLogger import *
...
# "Time-stamp: <06/30/2015  5:18:27 AM rsg>"

This "bmp" directory contains those Splash Screen(s) generated by:

  "/%s/tsLibGUI/tsWxGraphicalTextUserInterface.py.
    
using information defined in:

  "/%s/tsLibGUI/tsWxGlobals.py"
...
rows/lines), terminal/emulator type, and host operating system.
  ...
  Examples:
   ...
   "SplashScreen-[80x15_XTERM-256COLOR]-cygwin_nt-6.3.bmp" (16x16 color
                                                            ...
                                                            for Windows 8.1)
################# Technical Preview #########################################
##   "SplashScreen-[80x15_XTERM-256COLOR]-cygwin_nt-TBD.bmp" (16x16 color
##                                                            pair limit
##                                                            for Windows 10)
##
##   "SplashScreen-[60x15_XTERM]-cygwin_nt-TBD.bmp"          (Windows 10)
################# Technical Preview #########################################
...
have outlived their usefulness.''' % (tsWxGTUI_PyVx, tsWxGTUI_PyVx)
    ...
    try:
        ...
        try:
            ...
            sys.stderr.write('WARNING (file): <%s>' % str(e))

    except IOError, e:
        sys.stderr.write('WARNING (directory): <%s>' % str(e))
...
##            self.echo()
            ...
            mySysCommands = tsSysCommands.TsSysCommands()
            command = 'stty sane'
