#! /usr/bin/env python
# "Time-stamp: <04/08/2015  4:36:30 AM rsg>"
'''
tsWxPythonColor8SubstitutionMap.py - Refactored xterm (8-color)
substitution data base portion of tsWxGraphicalTextUserInterface
which maps wxPython color names to the available xterm (8-color)
names.
'''
#################################################################
#
# File: tsWxPythonColor8SubstitutionMap.py
#
# Purpose:
#
#    tsWxPythonColor8SubstitutionMap.py - Refactored xterm (8-color)
...
# Requirements:
#
#     Provide color8SubstitutionMap dictionary.
#
# Capabilities:
#
#
