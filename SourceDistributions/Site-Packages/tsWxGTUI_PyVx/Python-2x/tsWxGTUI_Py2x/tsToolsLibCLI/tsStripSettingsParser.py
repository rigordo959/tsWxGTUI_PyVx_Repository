#! /usr/bin/env python
#"Time-stamp: <04/22/2015  7:30:29 AM rsg>"
'''
tsStripSettingsParser.py - Class of utility functions,
used by the tsStripComments.py tool, to
parse the command line entered by the operator of the
tsStripComments application program. Parsing extracts
the Keyword-Value pair Options and Positional Arguments
that will configure and control the application during
its execution.
'''
#################################################################
#
...
#      entered by the operator of the tsStripComments
...
#                   tsLinesOfCodePkg.
#
#    2015/03/25 rsg Re-designed the user interface to default to
