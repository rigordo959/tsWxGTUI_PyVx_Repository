#! /usr/bin/env python
#"Time-stamp: <04/24/2015  5:34:09 AM rsg>"
'''
tsChange_wxPython_API_Version.py - Tool to generate a directory
of installable source files. It updates the identification of
the wxPython API Version most applicable to the tsWxGTUI_PyVx
Toolkit. 
'''
#################################################################
#
# File: tsChange_wxPython_API_Version.py
#
# Purpose:
#
#     Tool to generate a directory of installable source files.
#     It updates the identification of the wxPython API Version
#     most applicable to the tsWxGTUI_PyVx Toolkit. 
#
# Limitations:
#
# Usage (example):
#
#    python tsChange_wxPython_API_Version.py -s -i source -o destination
#
# Modifications:
#
...
__title__     = 'tsChange_wxPython_API_Version.py'
__version__   = '1.0.0'
__date__      = '04/24/2015'
...
# wxPython API version to search for
# and version to be substituted

oldVersion = 'wxPython 2.8.9.2 (New wxPyDocs)/wxWidgets 2.9.2 (Ref. Man.).'
newVersion = 'wxPython 3.0.2.0/wxWidgets 3.0.2.0.'
