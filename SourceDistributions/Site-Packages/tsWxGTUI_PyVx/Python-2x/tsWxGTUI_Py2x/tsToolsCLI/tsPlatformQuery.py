#! /usr/bin/env python
#"Time-stamp: <03/23/2015  2:02:13 PM rsg>"
'''
...
from tsLibCLI import tsExceptions
from tsLibCLI import tsLogger
from tsLibCLI import tsPlatformRunTimeEnvironment
...
##        import getopt
        ...
        resultsOptions = {
            ...
            "version": False,
            "debug": False,
            "output": "./%s_RunTimeEnvironment.txt" % __title__,
            "Verbose": False}
