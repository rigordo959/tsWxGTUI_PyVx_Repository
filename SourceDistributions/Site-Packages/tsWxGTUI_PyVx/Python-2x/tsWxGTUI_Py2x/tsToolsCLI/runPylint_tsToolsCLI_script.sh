#!/bin/bash
#"Time-stamp: <08/25/2016  8:27:44 AM rsg>"
# lookForErrors="E:"
# lookForWarnings="W:"
...
# makePyLint ./__init__
makePyLint ./__init__
makePyLint ./tsLinesOfCodeProjectMetrics
makePyLint ./tsPlatformQuery
makePyLint ./tsStripComments
makePyLint ./tsStripLineNumbers
makePyLint ./tsTreeCopy
